...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget _buildDataOverview(AppState state) {
    final reimburse = state.reimbursableSummary;
    return PaperGroup(
      title: '数据概况',
          ...
          if (reimburse.total > 0) ...[
            ...
            Row(
              children: [
                ...
                Text(
                  '待报销 ${AmountText.format(reimburse.total, showSymbol: false)}',
                  style: const TextStyle(
                      fontSize: 14,
              ...
              children: [
                ...
                for (final (label, days) in [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () => state.setRecurringRemindLead(days),
                      borderRadius: BorderRadius.circular(kRadiusTable),
                      child: Container(
                        padding: const EdgeInsets.symmetric(
                            horizontal: kSpace3, vertical: 5),
                        decoration: BoxDecoration(
                          color: state.recurringRemindLead == days
                              ? kAccentSoft
                              : const Color(0xFFF0F1EF),
                          borderRadius: BorderRadius.circular(kRadiusTable),
                          border: state.recurringRemindLead == days
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      InkWell(
                        onTap: () => setState(() =>
                            _nextDate = RecurringRule.nextAfter(
                                _nextDate, _frequency)),
                        borderRadius: BorderRadius.circular(kRadiusTable),
                        child: Container(
                          padding: const EdgeInsets.symmetric(
