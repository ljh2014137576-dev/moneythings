...
> 记账本 v4.65 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`97C11079F9A164B3591DA4D0661F0861197DC2FAC241D261DE06B3B46A377238`
...
- `flutter test`：161/161 通过（v4.65 预算卡点击调整）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
