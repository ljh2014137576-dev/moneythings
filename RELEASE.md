...
> 记账本 v4.55 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`2BCEE2E6B436E223971FB214820A796E30DD8BFCD8DB3E1F24B8A224628CE985`
...
- `flutter test`：151/151 通过（v4.55 多选合计金额）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
