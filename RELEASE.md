...
> 记账本 v4.46 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.6 MB）
- **SHA-256**：`542B684D518C95A650222FE74CB8685FE19428095B8257BD06CCFD0659389392`
...
- `flutter test`：136/136 通过（v4.46 明细全部账本）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
