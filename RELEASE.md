...
> 记账本 v4.40 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`C28410AAC1C43C6C20072A60BE33E195A8328CBBB7462DD9794C8080C81E2647`
...
- `flutter test`：128/128 通过（v4.40 周期规则复制）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
