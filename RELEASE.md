...
> 记账本 v4.58 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`B73328BF2B0F5FF98C20ABCEFC92AF45BD91040EEC7600C6F617A56473100B50`
...
- `flutter test`：155/155 通过（v4.58 周期全部补生成）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
