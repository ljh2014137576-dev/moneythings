...
> 记账本 v4.60 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`82D447E67AE16CBE686AEFA3767E2D2B02C1235C9EF579C0748A42AF4D78866C`
...
- `flutter test`：157/157 通过（v4.60 范围小结复制）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
