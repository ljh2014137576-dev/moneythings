...
> 记账本 v4.44 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.6 MB）
- **SHA-256**：`A1BF46253FF1291F0109404E7CC115EBABDC77C9D241BAAD3CD61F3FB6EC22DF`
...
- `flutter test`：135/135 通过（v4.44 常用备注自定义）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
