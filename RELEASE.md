...
> 记账本 v4.38 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`D95F22333622A79BED39A46BC2E98246336C10DD557C57E44A0B22E591C50606`
...
- `flutter test`：125/125 通过（v4.38 统计自定义范围记忆）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
