...
> 记账本 v4.67 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`245464E742581949A0B4C858A7760C7208557886096511550F79E58736ECC274`
...
- `flutter test`：163/163 通过（v4.67 预算卡金额显示）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
