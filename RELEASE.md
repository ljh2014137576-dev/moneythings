...
> 记账本 v4.29 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`4B13B27A587D301D5E2236C2912B90511F0E6783757FCFED4EF77DFB4E1FC3B1`
...
- `flutter test`：112/112 通过（v4.29 统计自定义范围结余走势）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
