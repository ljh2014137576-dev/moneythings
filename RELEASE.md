...
> 记账本 v4.49 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`751489E241FF400C1452AA5A7D37D99FE0EAA72F5872F2D7DEF220AA95EAB104`
...
- `flutter test`：143/143 通过（v4.49 周期提醒提前天数）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
