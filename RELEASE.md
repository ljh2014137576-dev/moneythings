...
> 记账本 v4.47 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.6 MB）
- **SHA-256**：`1EDD91A60147A5E3D86A671619107CA3AF8C9E5FF7B2DEF66C1851C353B2911F`
...
- `flutter test`：140/140 通过（v4.47 报销标记）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
