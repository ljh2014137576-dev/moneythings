...
> 记账本 v4.43 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`8671FD9CC239C43B1A61B84F3F02B6F4189EDE247784C92FCBCD3FEB03126E85`
...
- `flutter test`：133/133 通过（v4.43 常用金额自定义）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
