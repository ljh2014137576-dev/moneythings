...
> 记账本 v4.63 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`318468387265E32405817826873C7010FF6E621595591651B11BF5340585F7FF`
...
- `flutter test`：159/159 通过（v4.63 复制选中文本）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
