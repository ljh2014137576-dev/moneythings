...
> 记账本 v4.30 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`809F4A4CC62BC35B5037E255172E6349BA1B22940D96ABE7845B7AA6B2D59249`
...
- `flutter test`：114/114 通过（v4.30 周期规则按月补生成）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
