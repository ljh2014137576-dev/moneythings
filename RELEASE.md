...
> 记账本 v4.64 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`E645AD50902A5A0DAAD459D16E24CC9151BA40E83AA41C08027819A01A788B67`
...
- `flutter test`：160/160 通过（v4.64 搜索记录单删）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
