...
> 记账本 v4.33 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`8069E7EF36E1123A9063D13A17320E780A244B1D56E4301D0C890F009551DB1F`
...
- `flutter test`：117/117 通过（v4.33 明细按分类批量修改账户）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
