...
> 记账本 v4.36 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`F60EAD278ECFEFFC43B532C35191FE9F8DA4863997BF030D19A48025C636744D`
...
- `flutter test`：121/121 通过（v4.36 首页本周支出分类）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
