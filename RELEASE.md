...
> 记账本 v4.25 · 2026-08-08 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（53.7 MB）
- **SHA-256**：`37472DBC76F8865AECCF3AAC4A7DFB0A7E0B9ACB44FC87E799CF55FAA6395843`
...
- `flutter test`：107/107 通过（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
