...
> 记账本 v4.48 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`8EF361237AC92BFF71840DA59AD1EA1F4FF380E0710EBC90AFA7FFB1415926F8`
...
- `flutter test`：141/141 通过（v4.48 明细复制选中到账本）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
