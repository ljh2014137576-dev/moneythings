...
> 记账本 v4.53 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`593C0C8CC46548C38870067D629D46D6FFF2E40344BD662EC8152117972B406E`
...
- `flutter test`：149/149 通过（v4.53 明细账本名）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
