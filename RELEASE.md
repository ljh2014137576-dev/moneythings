...
> 记账本 v4.54 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`E2DD7110FAEC9D45F5195E80ABC2F8549A7D1FC64A171FBF1F33234C4909CC0E`
...
- `flutter test`：150/150 通过（v4.54 账本汇总合计行）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
