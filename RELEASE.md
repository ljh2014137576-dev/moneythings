...
> 记账本 v4.51 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`009CE3E71F8B9F9DCFFC4F5BC32435F1FAE64FCD1A694F06FA10B16DE62D2263`
...
- `flutter test`：146/146 通过（v4.51 批量标记可报销）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
