...
> 记账本 v4.35 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`E7CF22F4F810EE040FA6BA8444EA9B71F415BACB2D0D992962CDB9A72F97318E`
...
- `flutter test`：120/120 通过（v4.35 周期记账到期提醒）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
