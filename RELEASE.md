...
> 记账本 v4.62 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`15F5E38417AB8CA33C741920B445455A910CEE0CE6F775EF6204AD15A02FFEF6`
...
- `flutter test`：158/158 通过（v4.62 周期CSV首次日期）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
