...
> 记账本 v4.56 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`A26875BA035D792E63D43496EF5EB055B6802013AA16313A66CFC7CDA9389A64`
...
- `flutter test`：152/152 通过（v4.56 下次日期+1期）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
