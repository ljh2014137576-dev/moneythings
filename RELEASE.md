...
> 记账本 v4.50 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.7 MB）
- **SHA-256**：`B98B18FCA26317B7B4B5E4174660AE14B5C3282C2653C088EBD027666511F8D2`
...
- `flutter test`：145/145 通过（v4.50 结余走势粒度）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
