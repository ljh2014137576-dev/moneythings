...
> 记账本 v4.34 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`3E4B5EA7BE6BE69F53C1F60F658D9E4C146A63B93A53D1B0C2DC89F713690C44`
...
- `flutter test`：118/118 通过（v4.34 明细按分类批量删除）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
