...
> 记账本 v4.32 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`60B4756B63D25EA4BB9B441921E1333A9BF8B30F0259219A458EC565FC32AA6A`
...
- `flutter test`：116/116 通过（v4.32 统计年度收入对比）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
