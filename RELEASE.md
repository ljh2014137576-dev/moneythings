...
> 记账本 v4.45 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.6 MB）
- **SHA-256**：`FF32E89A93A35326EDE2E228539E745E2394C6ED2A25CC5CE34C53B009086400`
...
- `flutter test`：135/135 通过（v4.45 范围每日收入图）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
