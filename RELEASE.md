...
> 记账本 v4.31 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`65AB23887C0BBB8BEBA2394AEB1B0510A039A814FC61412555344CDA052E6834`
...
- `flutter test`：115/115 通过（v4.31 明细按分类移动到其他账本）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
