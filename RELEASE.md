...
> 记账本 v4.39 · 2026-08-07 · 可上架状态

## 安装包

- **Release APK**：`build/app/outputs/flutter-apk/app-release.apk`（54.5 MB）
- **SHA-256**：`14E1C31947F4EB17C75C29A7F618208147A49CE6B23ADB70D99E7A1D45603096`
...
- `flutter test`：127/127 通过（v4.39 首页账本汇总）（含大字体 2.0x 无障碍、JSON 备份恢复、多账本（含明细复制到其他账本）、预算按账本、导入预览等）
